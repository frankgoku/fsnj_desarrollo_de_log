...
<html lang="es-SV">
    <head>
        <TItle>INICIO DE SESION: FRANK STEVENS NAVARRO JUSTINIANO</TItle>
        <META charset="UFT-8">
        ...
        <script  type="text/javacript" src="js/sweetalert.all.js"></script>
        <script  type="text/javacript" src="font/fontawesome/js/all.js"></script>
    </head>
    <body>
